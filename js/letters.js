document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.close-modal-btn').forEach(btn => btn.addEventListener('click', function() { 
    ...
    function renderLetters() {
        ...
        letters.forEach(letter => {
            ...
            // Layout updated to use Flexbox instead of absolute positioning for buttons
            card.innerHTML = `
